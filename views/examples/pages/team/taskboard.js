...
(function (document, window, $) {
    ...
    window.Content = {
        ...
        taskTpl: function (data) {
            return '<li class="list-group-item priority-' + data.priority + '" data-taskboard="slidePanel" data-url="/views/examples/pages/team/taskboard.tpl">' +
        ...
        init: function () {
            var self = this;
            $.getJSON($.ctx + '/views/examples/pages/team/taskboard.json', function (data) {
