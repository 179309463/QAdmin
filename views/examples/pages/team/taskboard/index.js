...
(function (document, window, $) {
    ...
    window.Content = {
        ...
        taskTpl: function (data) {
            return '<li class="list-group-item priority-' + data.priority + '" data-taskboard="slidePanel" data-url="/views/examples/pages/team/taskboard/index.tpl">' +
                ...
                '<li><img class="avatar avatar-sm" src="/assets/images/portraits/5.jpg"></li>' +
                '</div>' +
                '</li>';
        },
        ...
        init: function () {
            var self = this;
            $.getJSON($.ctx + '/views/examples/pages/team/taskboard/index.json', function (data) {
        ...
        handleSelective: function ($target, selected) {
            ...
            var members = [{
                ...
                id: 'uid_5',
                name: '陈媚婉',
                img: '/assets/images/portraits/5.jpg'
            }, {
                id: 'uid_6',
                name: '嵇慧莉',
                img: '/assets/images/portraits/6.jpg'
            }];
