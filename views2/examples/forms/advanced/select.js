...
(function (document, window, $) {
    ...
    window.Content = {
        ...
        typeahead: function () { // Typeahead
            ...
            // ----------------
                var countries = new Bloodhound({
                    datumTokenizer: Bloodhound.tokenizers.whitespace,
                    queryTokenizer: Bloodhound.tokenizers.whitespace,
                    prefetch: $.ctx + '/views/examples/forms/advanced/index.countries.json'
                });
        ...
        initCxSelect: function(){
            $.cxSelect($('#cityChina'), { url: $('#cityChina').data('url'), selects: ['province', 'city', 'area'], emptyStyle: 'hidden' });
            $.cxSelect($('#cityChinaVal'), { url: $('#cityChinaVal').data('url'), selects: ['province', 'city', 'area'], emptyStyle: 'hidden' });
            $.cxSelect($('#globalLocation'), { url: $('#globalLocation').data('url'), selects: ['country', 'state', 'city', 'region'], emptyStyle: 'hidden' });
            $.cxSelect($('#customData'), {
